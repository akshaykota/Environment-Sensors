...
public class PlotActivity1 extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        xAccSeries = new SimpleXYSeries("Azimuth");
        yAccSeries = new SimpleXYSeries("Pitch");
        zAccSeries = new SimpleXYSeries("Roll");

        // setup the accData plot:
        accDataPlot = findViewById(R.id.accDataPlot);

        xHistorySeries = new SimpleXYSeries("Azimuth");
        ...
        accDataPlot.setRangeBoundaries(-100, 100, BoundaryMode.FIXED);
        ...
        accDataPlot.setRangeLabel("Orientation (degrees)");
